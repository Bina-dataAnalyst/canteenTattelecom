...
export const MacrosModal = ({ isOpen, onClose }: { isOpen: boolean, onClose: () => void }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white rounded-[40px] w-full max-w-md p-8 relative shadow-2xl">
        ...
        <h2 className="text-2xl font-black mb-2 uppercase italic tracking-tighter">Твой баланс БЖУ</h2>
        <p className="text-gray-500 text-sm mb-6">Распределение нутриентов в твоем текущем заказе</p>
        ...
        <div className="grid grid-cols-3 gap-4 mt-6">
          <div className="text-center">
            <p className="text-[10px] text-gray-400 uppercase font-bold">Белки</p>
            <p className="text-lg font-black text-[#4CAF50]">{stats.proteins}г</p>
          </div>
          <div className="text-center">
            <p className="text-[10px] text-gray-400 uppercase font-bold">Жиры</p>
            <p className="text-lg font-black text-[#FB8C00]">{stats.fats}г</p>
          </div>
          <div className="text-center">
            <p className="text-[10px] text-gray-400 uppercase font-bold">Углеводы</p>
